...
**status** — call `status`. **Print `banner` verbatim inside one fenced code block** (the motivator: a
...
count is reached; close with 2–4 honest lines. On the first drill of the day
